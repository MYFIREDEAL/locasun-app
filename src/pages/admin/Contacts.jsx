    ...
    >
      ...
      <div className="flex items-center gap-2 overflow-x-auto no-scrollbar pb-2">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent>
            <DropdownMenuCheckboxItem checked={!selectedTag} onCheckedChange={(checked) => { console.log('Tags menu: Tous clicked, checked=', checked); if (checked) setSelectedTag(null); }} >Tous</DropdownMenuCheckboxItem>
            <DropdownMenuSeparator />
            {allTags.map(tag => (
              <DropdownMenuCheckboxItem key={tag} checked={selectedTag === tag} onCheckedChange={(checked) => { console.log('Tags menu: tag=', tag, 'checked=', checked); if (checked) setSelectedTag(tag); else setSelectedTag(null); }}>{tag}</DropdownMenuCheckboxItem>
            ))}
          </DropdownMenuContent>
        </DropdownMenu>
